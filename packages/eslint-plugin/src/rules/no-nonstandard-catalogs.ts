...
export const meta: ruleNoNonstandardCatalogs.RuleMetaData = {
  ...
  fixable: "code",
  docs: {
    description: "warns the nonstandard uses of Catalog that hi18n cannot properly process",
    recommended: true,
  },
  messages: {
...
export function create(context: ruleNoNonstandardCatalogs.RuleContext): ruleNoNonstandardCatalogs.RuleListener {
