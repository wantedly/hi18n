...
describe("InferredMessageType", () => {
  ...
  describe("Compatibility with parseMessage", () => {
    ...
    it("errors on invalid pluralArg", () => {
      ...
      expectType<InferredMessageType<"{foo,plural}">>().to(beTypeEqual<ParseError<"Unexpected token } (expected ,)">>());
      expectType<InferredMessageType<"{foo,plural,$}">>().to(beTypeEqual<ParseError<"Unexpected token $ (expected offset:, identifier, =, })">>());
      expectType<InferredMessageType<"{foo,plural,}">>().to(beTypeEqual<ParseError<"No branch found">>());
      expectType<InferredMessageType<"{foo,plural,=foo{}other{}}">>().to(beTypeEqual<ParseError<"Unexpected token identifier (expected number)">>());
      expectType<InferredMessageType<"{foo,plural,= 42{}other{}}">>().to(beTypeEqual<ParseError<"No space allowed here">>());
      ...
      expectType<InferredMessageType<"{foo,plural,42{}other{}}">>().to(beTypeEqual<ParseError<"Unexpected token number (expected offset:, identifier, =, })">>());
