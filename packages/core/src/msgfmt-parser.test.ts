...
describe("parseMessage", () => {
  ...
  it("errors on invalid pluralArg", () => {
    ...
    expect(() => parseMessage("{foo,plural}")).toThrow("Unexpected token } (expected ,)");
    expect(() => parseMessage("{foo,plural,$}")).toThrow("Unexpected token $ (expected offset:, identifier, =, })");
    expect(() => parseMessage("{foo,plural,}")).toThrow("No branch found");
    expect(() => parseMessage("{foo,plural,=foo{}other{}}")).toThrow("Unexpected token identifier (expected number)");
    expect(() => parseMessage("{foo,plural,= 42{}other{}}")).toThrow("No space allowed here");
    ...
    expect(() => parseMessage("{foo,plural,42{}other{}}")).toThrow("Unexpected token number (expected offset:, identifier, =, })");
